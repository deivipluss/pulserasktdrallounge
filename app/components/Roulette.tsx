...
interface RouletteProps {
  ...
  forcedPrize?: string; // Nombre del premio forzado (e.g. "cigarrillos")
}

export default function Roulette({ onResult, disabled = false, rewardsOverride, forcedPrize }: RouletteProps) {
  ...
  const determineReward = (): Reward => {
    ...
    // Si no hay premio forzado o no se encontró, usar probabilidades
